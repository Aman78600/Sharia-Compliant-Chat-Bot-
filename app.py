...
def ask_question(index_of_data, question):
    ...
    prompt = f""" this is a index page =>###{index_of_data}###. \n\n i want that topic number whar i found this {question} answer.
      (give me only topic number only number not more than it. and if contant is present in other topic so give me that number also.)
     
    ###if that topic not in given list###
    so give me answer this question or talme about this => ###{question}### if you know  about it. athore wise say i don't know.

    (this time i dont want topic number.)"""
